...
import { addStock, createProductInventory, reduceStock, updateProductInventory } from '../controllers/inventoryController.js';
...
// reduce stock
router.post('/reduce-stock/:productId', reduceStock);
