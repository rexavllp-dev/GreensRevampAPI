...
export const getPublicProducts = async (page, per_page, search, filters, sort) => {
    ...
    let query = db('products')
        ...
        .select(
            ...
            'product_price.updated_at as product_price_updated_at',
            "product_inventory.*",
            ...
            "product_badge.created_at as product_badge_created_at",
            "product_badge.updated_at as product_badge_updated_at",
            "product_category.*",
